...
public class SimpleRangedAttackGoal<T extends MobEntity & IRangedAttackMob> extends Goal {
    private final T mob;
    ...
    public SimpleRangedAttackGoal(T p_i47515_1_, double p_i47515_2_, int p_i47515_4_, float p_i47515_5_) {
