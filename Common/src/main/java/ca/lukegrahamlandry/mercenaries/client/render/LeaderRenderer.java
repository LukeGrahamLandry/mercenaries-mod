...
public class LeaderRenderer extends LivingEntityRenderer<LeaderEntity, PlayerModel<LeaderEntity>> {
    public LeaderRenderer(EntityRendererProvider.Context context) {
    ...
    @Override
    public void render(LeaderEntity p_225623_1_, float p_225623_2_, float p_225623_3_, PoseStack p_225623_4_, MultiBufferSource p_225623_5_, int p_225623_6_) {
        this.setModelProperties(p_225623_1_);
        super.render(p_225623_1_, p_225623_2_, p_225623_3_, p_225623_4_, p_225623_5_, p_225623_6_);
    }

    @Override
    public Vec3 getRenderOffset(LeaderEntity p_225627_1_, float p_225627_2_) {
        return p_225627_1_.isCrouching() ? new Vec3(0.0D, -0.125D, 0.0D) : super.getRenderOffset(p_225627_1_, p_225627_2_);
    }

    private void setModelProperties(LeaderEntity p_177137_1_) {
        PlayerModel<LeaderEntity> playermodel = this.getModel();
    ...
    private static HumanoidModel.ArmPose getArmPose(LeaderEntity p_241741_0_, InteractionHand p_241741_1_) {
    ...
    public ResourceLocation getTextureLocation(LeaderEntity merc) {
        return merc.getTexture();
    }

    protected void scale(LeaderEntity p_225620_1_, PoseStack p_225620_2_, float p_225620_3_) {
        float f = 0.9375F;
        p_225620_2_.scale(0.9375F, 0.9375F, 0.9375F);
    }


    public void renderRightHand(PoseStack p_229144_1_, MultiBufferSource p_229144_2_, int p_229144_3_, LeaderEntity p_229144_4_) {
        this.renderHand(p_229144_1_, p_229144_2_, p_229144_3_, p_229144_4_, (this.model).rightArm, (this.model).rightSleeve);
    }

    public void renderLeftHand(PoseStack p_229146_1_, MultiBufferSource p_229146_2_, int p_229146_3_, LeaderEntity p_229146_4_) {
        this.renderHand(p_229146_1_, p_229146_2_, p_229146_3_, p_229146_4_, (this.model).leftArm, (this.model).leftSleeve);
    }

    private void renderHand(PoseStack p_229145_1_, MultiBufferSource p_229145_2_, int p_229145_3_, LeaderEntity p_229145_4_, ModelPart p_229145_5_, ModelPart p_229145_6_) {
        PlayerModel<LeaderEntity> playermodel = this.getModel();
    ...
    protected void setupRotations(LeaderEntity p_225621_1_, PoseStack p_225621_2_, float p_225621_3_, float p_225621_4_, float p_225621_5_) {
        ...
        if (p_225621_1_.isFallFlying()) {
            ...
            Vec3 v = p_225621_1_.getViewVector(p_225621_5_);
            Vec3 v1 = p_225621_1_.getDeltaMovement();
            double d0 = v1.horizontalDistanceSqr();
            double d1 = v.horizontalDistanceSqr();
            if (d0 > 0.0D && d1 > 0.0D) {
                double d2 = (v1.x * v.x + v1.z * v.z) / Math.sqrt(d0 * d1);
                double d3 = v1.x * v.z - v1.z * v.x;
