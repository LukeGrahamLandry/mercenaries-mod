...
public class MercMountModel extends EntityModel<MercMountEntity> {
    ...
    public void setupAnim(MercMountEntity p_225597_1_, float p_225597_2_, float p_225597_3_, float p_225597_4_, float p_225597_5_, float p_225597_6_) {
        boolean lvt_7_1_ = false; // p_225597_1_.isSaddled();
        ...
        for(var11 = 0; var11 < var10; ++var11) {
            lvt_12_2_ = var9[var11];
            lvt_12_2_.visible = lvt_8_1_ && lvt_7_1_;
        }
    ...
    public void prepareMobModel(MercMountEntity mount, float p_212843_2_, float p_212843_3_, float p_212843_4_) {
